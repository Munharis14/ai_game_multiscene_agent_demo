...
本 Demo 通过 LangChain Tool 与 RAG 技术构建一个游戏研发文档问答 Agent，验证 AI 在研发知识检索场景中的可行性。用户输入自然语言问题后，Agent 判断需要调用文档检索工具，从知识库中检索相关文档片段，再基于这些片段生成回答，并展示执行过程与引用来源。
...
| LangChain Tool | 将文档检索能力封装为 Agent 可调用工具 |
| Chroma | 存储和检索文档向量 |
